        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="text-sm font-bold uppercase text-gray-700">
              Place Your Essay Order in Minutes
            </p>
            <h2 className="mt-6 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl">
              Bespoke Essays, Simply Crafted
            </h2>
            <p className="mx-auto mt-4 max-w-2xl text-lg font-normal text-gray-700 lg:text-xl lg:leading-8">
              "Order a personalized essay easily: share your requirements, make
              your payment, and let us take care of the rest!"
            </p>
          </div>
          <ul className="mx-auto mt-12 grid grid-cols-1 gap-10 sm:mt-16 lg:mt-20 lg:grid-cols-4">
            <li className="flex-start group justify-center items-center text-center relative flex lg:flex-col">
              ...
              <div className="ml-6 lg:ml-0 lg:mt-10">
                ...
                <h4 className="mt-2 text-base text-gray-700">
                  Provide essay details effortlessly through our intuitive form.
                </h4>
              </div>
            </li>
            <li className="flex-start group justify-center items-center text-center relative flex lg:flex-col">
              ...
              <div className="ml-6 lg:ml-0 lg:mt-10">
                ...
                <h4 className="mt-2 text-base text-gray-700">
                  Handpick or let us match you with the perfect writer.
                </h4>
              </div>
            </li>
            <li className="flex-start group justify-center items-center text-center relative flex lg:flex-col">
              ...
              <div className="ml-6 lg:ml-0 lg:mt-10">
                ...
                <h4 className="mt-2 text-base text-gray-700">
                  Track progress and chat with your writer for seamless
                  collaboration.
                </h4>
              </div>
            </li>
            <li className="flex-start group justify-center items-center text-center relative flex lg:flex-col">
              ...
              <div className="ml-6 lg:ml-0 lg:mt-10">
                ...
                <h4 className="mt-2 text-base text-gray-700">
                  Receive, review, and request revisions for a perfect essay.
                </h4>
              </div>
            </li>
          </ul>
